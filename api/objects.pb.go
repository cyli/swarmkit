...
type Secret struct {
	ID         string        `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta       Meta          `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	SecretData []*SecretData `protobuf:"bytes,3,rep,name=secret_data,json=secretData" json:"secret_data,omitempty"`
	// Name of the secret
...
func (m *Secret) Copy() *Secret {
	...
	if m.SecretData != nil {
		o.SecretData = make([]*SecretData, 0, len(m.SecretData))
		for _, v := range m.SecretData {
			o.SecretData = append(o.SecretData, v.Copy())
		}
	}
...
func (this *Secret) GoString() string {
	...
	if this.SecretData != nil {
		s = append(s, "SecretData: "+fmt.Sprintf("%#v", this.SecretData)+",\n")
	}
...
func (this *Secret) String() string {
	...
	s := strings.Join([]string{`&Secret{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`SecretData:` + strings.Replace(fmt.Sprintf("%v", this.SecretData), "SecretData", "SecretData", 1) + `,`,
...
func (m *Secret) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.SecretData = append(m.SecretData, &SecretData{})
			if err := m.SecretData[len(m.SecretData)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
var fileDescriptorObjects = []byte{
	...
	,
}
