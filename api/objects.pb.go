...
type Cluster struct {
	...
	// RootRotationState tracks the current state of a root CA rotation.
	RootRotationState *RootRotationState `protobuf:"bytes,10,opt,name=root_rotation_state,json=rootRotationState" json:"root_rotation_state,omitempty"`
}
...
func (m *Cluster) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.RootRotationState != nil {
		m.RootRotationState = &RootRotationState{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.RootRotationState, o.RootRotationState)
	}
}
...
func (m *Cluster) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RootRotationState != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.RootRotationState.Size()))
		n33, err := m.RootRotationState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (this *Cluster) String() string {
	...
	s := strings.Join([]string{`&Cluster{`,
		...
		`RootRotationState:` + strings.Replace(fmt.Sprintf("%v", this.RootRotationState), "RootRotationState", "RootRotationState", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Cluster) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootRotationState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RootRotationState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorObjects = []byte{
	...
	,
}
