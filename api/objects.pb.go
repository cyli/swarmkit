...
type Cluster struct {
	...
	UnlockKeys UnlockKeys `protobuf:"bytes,9,opt,name=unlock_keys,json=unlockKeys" json:"unlock_keys"`
}
...
func (this *Cluster) GoString() string {
	...
	s = append(s, "UnlockKeys: "+strings.Replace(this.UnlockKeys.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Cluster) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x4a
	i++
	i = encodeVarintObjects(data, i, uint64(m.UnlockKeys.Size()))
	n33, err := m.UnlockKeys.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n33
...
func (this *Cluster) String() string {
	...
	s := strings.Join([]string{`&Cluster{`,
		...
		`UnlockKeys:` + strings.Replace(strings.Replace(this.UnlockKeys.String(), "UnlockKeys", "UnlockKeys", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Cluster) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if err := m.UnlockKeys.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorObjects = []byte{
	...
	,
}
