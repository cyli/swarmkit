...
type KeyRotation struct {
	...
	// RootCARotation tells UpdateCluster whether the root CA cert and/or key should be updated
	RootCARotation bool `protobuf:"varint,4,opt,name=root_ca_rotation,json=rootCaRotation,proto3" json:"root_ca_rotation,omitempty"`
	// RootCACert specifies, if provided, the root CA cert UpdateCluster should use when rotating
	// If not provided, and a key is provided, the certificate will instead be generated.
	RootCACert []byte `protobuf:"bytes,5,opt,name=root_ca_cert,json=rootCaCert,proto3" json:"root_ca_cert,omitempty"`
	// RootCAKey specifies, if provided, the root CA key UpdateCluster should use when rotating.
	// The key must match the CA cert, if the CA cert is provided.  It is possible to provided
	// only the CA cert and not the key, if there are additional external CA urls provided
	// that match the CA cert.
	RootCAKey []byte `protobuf:"bytes,6,opt,name=root_ca_key,json=rootCaKey,proto3" json:"root_ca_key,omitempty"`
}
...
// UpdateRootRotationRequest specifies which phase of the root rotation to transition into
type UpdateRootRotationRequest struct {
	// ClusterID is the cluster ID to update.
	ClusterID string `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	// DesiredState is the desired root rotation state
	DesiredState RootRotationState_State `protobuf:"varint,2,opt,name=DesiredState,json=desiredState,proto3,enum=docker.swarmkit.v1.RootRotationState_State" json:"DesiredState,omitempty"`
}

func (m *UpdateRootRotationRequest) Reset()      { *m = UpdateRootRotationRequest{} }
func (*UpdateRootRotationRequest) ProtoMessage() {}
func (*UpdateRootRotationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorControl, []int{49}
}

// UpdateRootRotationResponse is an empty object indicating the successful transition of
// the root rotation.
type UpdateRootRotationResponse struct {
}

func (m *UpdateRootRotationResponse) Reset()      { *m = UpdateRootRotationResponse{} }
func (*UpdateRootRotationResponse) ProtoMessage() {}
func (*UpdateRootRotationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorControl, []int{50}
}
...
func init() {
	...
	proto.RegisterType((*UpdateRootRotationRequest)(nil), "docker.swarmkit.v1.UpdateRootRotationRequest")
	proto.RegisterType((*UpdateRootRotationResponse)(nil), "docker.swarmkit.v1.UpdateRootRotationResponse")
...
func (p *authenticatedWrapperControlServer) UpdateRootRotation(ctx context.Context, r *UpdateRootRotationRequest) (*UpdateRootRotationResponse, error) {

	if err := p.authorize(ctx, []string{"swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.UpdateRootRotation(ctx, r)
}
...
func (m *UpdateRootRotationRequest) Copy() *UpdateRootRotationRequest {
	if m == nil {
		return nil
	}
	o := &UpdateRootRotationRequest{}
	o.CopyFrom(m)
	return o
}

func (m *UpdateRootRotationRequest) CopyFrom(src interface{}) {

	o := src.(*UpdateRootRotationRequest)
	*m = *o
}

func (m *UpdateRootRotationResponse) Copy() *UpdateRootRotationResponse {
	if m == nil {
		return nil
	}
	o := &UpdateRootRotationResponse{}
	o.CopyFrom(m)
	return o
}

func (m *UpdateRootRotationResponse) CopyFrom(src interface{}) {}
...
type ControlClient interface {
	...
	UpdateRootRotation(ctx context.Context, in *UpdateRootRotationRequest, opts ...grpc.CallOption) (*UpdateRootRotationResponse, error)
}
...
func (c *controlClient) UpdateRootRotation(ctx context.Context, in *UpdateRootRotationRequest, opts ...grpc.CallOption) (*UpdateRootRotationResponse, error) {
	out := new(UpdateRootRotationResponse)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Control/UpdateRootRotation", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControlServer interface {
	...
	UpdateRootRotation(context.Context, *UpdateRootRotationRequest) (*UpdateRootRotationResponse, error)
}
...
func _Control_UpdateRootRotation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateRootRotationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControlServer).UpdateRootRotation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Control/UpdateRootRotation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControlServer).UpdateRootRotation(ctx, req.(*UpdateRootRotationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Control_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateRootRotation",
			Handler:    _Control_UpdateRootRotation_Handler,
		},
	},
...
func (m *KeyRotation) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RootCACert) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintControl(dAtA, i, uint64(len(m.RootCACert)))
		i += copy(dAtA[i:], m.RootCACert)
	}
	if len(m.RootCAKey) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintControl(dAtA, i, uint64(len(m.RootCAKey)))
		i += copy(dAtA[i:], m.RootCAKey)
	}
	return i, nil
}
...
func (m *UpdateRootRotationRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateRootRotationRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.DesiredState != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.DesiredState))
	}
	return i, nil
}

func (m *UpdateRootRotationResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateRootRotationResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (p *raftProxyControlServer) UpdateRootRotation(ctx context.Context, r *UpdateRootRotationRequest) (*UpdateRootRotationResponse, error) {
	...
	resp, err := NewControlClient(conn).UpdateRootRotation(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewControlClient(conn).UpdateRootRotation(modCtx, r)
	}
	return resp, err
}
...
func (m *UpdateRootRotationRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.ClusterID)
	if l > 0 {
	...
	if m.DesiredState != 0 {
		n += 1 + sovControl(uint64(m.DesiredState))
	}
	return n
}

func (m *UpdateRootRotationResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (this *KeyRotation) String() string {
	...
	s := strings.Join([]string{`&KeyRotation{`,
		...
		`RootCARotation:` + fmt.Sprintf("%v", this.RootCARotation) + `,`,
		`RootCACert:` + fmt.Sprintf("%v", this.RootCACert) + `,`,
		`RootCAKey:` + fmt.Sprintf("%v", this.RootCAKey) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *UpdateRootRotationRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateRootRotationRequest{`,
		`ClusterID:` + fmt.Sprintf("%v", this.ClusterID) + `,`,
...
func (this *UpdateRootRotationResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateRootRotationResponse{`,
		`}`,
	}, "")
	return s
}
...
func (m *KeyRotation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootCARotation", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RootCARotation = bool(v != 0)
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootCACert", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RootCACert = append(m.RootCACert[:0], dAtA[iNdEx:postIndex]...)
			if m.RootCACert == nil {
				m.RootCACert = []byte{}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootCAKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RootCAKey = append(m.RootCAKey[:0], dAtA[iNdEx:postIndex]...)
			if m.RootCAKey == nil {
				m.RootCAKey = []byte{}
			}
			iNdEx = postIndex
...
func (m *UpdateRootRotationRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateRootRotationRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateRootRotationRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DesiredState |= (RootRotationState_State(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *UpdateRootRotationResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateRootRotationResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateRootRotationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorControl = []byte{
	...
	,
}
