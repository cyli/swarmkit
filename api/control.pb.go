...
type JoinTokenRotation struct {
	...
	// RotateManagerToken tells UpdateCluster to rotate the manager secret.
...
type UnlockKeyRotation struct {
	// RotateManagerKey tells UpdateCluster to rotate the manager unlock key.
	RotateManagerKey bool `protobuf:"varint,1,opt,name=rotate_manager_key,json=rotateManagerKey,proto3" json:"rotate_manager_key,omitempty"`
}

func (m *UnlockKeyRotation) Reset()                    { *m = UnlockKeyRotation{} }
func (*UnlockKeyRotation) ProtoMessage()               {}
func (*UnlockKeyRotation) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{37} }
...
type UpdateClusterRequest struct {
	...
	// UnlockKeyRotation contains flags for rotating the unlock key
	UnlockRotation UnlockKeyRotation `protobuf:"bytes,5,opt,name=unlock_rotation,json=unlockRotation" json:"unlock_rotation"`
}
...
func (*GetSecretRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{40} }
...
func (*GetSecretResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{41} }
...
func (*UpdateSecretRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{42} }
...
func (*UpdateSecretResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{43} }
...
func (*ListSecretsRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{44} }
...
func (*ListSecretsResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{45} }
...
func (*CreateSecretRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{46} }
...
func (*CreateSecretResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{47} }
...
func (*RemoveSecretRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{48} }
...
func (*RemoveSecretResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{49} }
...
func init() {
	...
	proto.RegisterType((*UnlockKeyRotation)(nil), "docker.swarmkit.v1.UnlockKeyRotation")
...
func (m *UnlockKeyRotation) Copy() *UnlockKeyRotation {
	if m == nil {
		return nil
	}

	o := &UnlockKeyRotation{
		RotateManagerKey: m.RotateManagerKey,
	}
...
func (m *UpdateClusterRequest) Copy() *UpdateClusterRequest {
	...
	o := &UpdateClusterRequest{
		...
		UnlockRotation: *m.UnlockRotation.Copy(),
	}
...
func (this *UnlockKeyRotation) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&api.UnlockKeyRotation{")
	s = append(s, "RotateManagerKey: "+fmt.Sprintf("%#v", this.RotateManagerKey)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *UpdateClusterRequest) GoString() string {
	...
	s = append(s, "UnlockRotation: "+strings.Replace(this.UnlockRotation.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *UnlockKeyRotation) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *UnlockKeyRotation) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.RotateManagerKey {
		data[i] = 0x8
		i++
		if m.RotateManagerKey {
			data[i] = 1
...
func (m *UpdateClusterRequest) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x2a
	i++
	i = encodeVarintControl(data, i, uint64(m.UnlockRotation.Size()))
	n24, err := m.UnlockRotation.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n24
...
func (m *UpdateSecretRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.SecretVersion != nil {
		...
		n27, err := m.SecretVersion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *CreateSecretResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.Secret != nil {
		...
		i++
		i = encodeVarintControl(data, i, uint64(m.Secret.Size()))
		n32, err := m.Secret.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *UnlockKeyRotation) Size() (n int) {
	var l int
	_ = l
	if m.RotateManagerKey {
		n += 2
...
func (this *UnlockKeyRotation) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UnlockKeyRotation{`,
		`RotateManagerKey:` + fmt.Sprintf("%v", this.RotateManagerKey) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateClusterRequest) String() string {
	...
	s := strings.Join([]string{`&UpdateClusterRequest{`,
		...
		`UnlockRotation:` + strings.Replace(strings.Replace(this.UnlockRotation.String(), "UnlockKeyRotation", "UnlockKeyRotation", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UnlockKeyRotation) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnlockKeyRotation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnlockKeyRotation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RotateManagerKey", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *UpdateClusterRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnlockRotation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.UnlockRotation.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorControl = []byte{
	...
	,
}
