...
type RootRotationState_State int32

const (
	RootRotationState_RotationDone        RootRotationState_State = 0
	RootRotationState_CertificateRotation RootRotationState_State = 1
	RootRotationState_SignerRotation      RootRotationState_State = 2
	RootRotationState_RotationAborted     RootRotationState_State = 3
)

var RootRotationState_State_name = map[int32]string{
	0: "NONE",
	1: "CERTIFICATE_ROTATION",
	2: "SIGNER_ROTATION",
	3: "ROTATION_ABORTED",
}
var RootRotationState_State_value = map[string]int32{
	"NONE":                 0,
	"CERTIFICATE_ROTATION": 1,
	"SIGNER_ROTATION":      2,
	"ROTATION_ABORTED":     3,
}

func (x RootRotationState_State) String() string {
	return proto.EnumName(RootRotationState_State_name, int32(x))
}
func (RootRotationState_State) EnumDescriptor() ([]byte, []int) {
...
type ExternalCA struct {
	...
	// CACertHash specifies the hash of the CA cert that this external CA URL corresponds
	// to.  This is used help rotate root CAs from one external CA to another.
	CACertHash string `protobuf:"bytes,4,opt,name=ca_cert_hash,json=caCertHash,proto3" json:"ca_cert_hash,omitempty"`
}
...
type RootRotationState struct {
	State     RootRotationState_State `protobuf:"varint,1,opt,name=state,proto3,enum=docker.swarmkit.v1.RootRotationState_State" json:"state,omitempty"`
	NewCACert []byte                  `protobuf:"bytes,2,opt,name=new_ca_cert,json=newCaCert,proto3" json:"new_ca_cert,omitempty"`
	NewCAKey  []byte                  `protobuf:"bytes,3,opt,name=new_ca_key,json=newCaKey,proto3" json:"new_ca_key,omitempty"`
	OldCACert []byte                  `protobuf:"bytes,4,opt,name=old_ca_cert,json=oldCaCert,proto3" json:"old_ca_cert,omitempty"`
	OldCAKey  []byte                  `protobuf:"bytes,5,opt,name=old_ca_key,json=oldCaKey,proto3" json:"old_ca_key,omitempty"`
}

func (m *RootRotationState) Reset()                    { *m = RootRotationState{} }
func (*RootRotationState) ProtoMessage()               {}
func (*RootRotationState) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{46} }
...
func init() {
	...
	proto.RegisterType((*RootRotationState)(nil), "docker.swarmkit.v1.RootRotationState")
	...
	proto.RegisterEnum("docker.swarmkit.v1.RootRotationState_State", RootRotationState_State_name, RootRotationState_State_value)
}
...
func (m *RootRotationState) Copy() *RootRotationState {
	if m == nil {
		return nil
	}
	o := &RootRotationState{}
...
func (m *RootRotationState) CopyFrom(src interface{}) {

	o := src.(*RootRotationState)
	*m = *o
}
...
func (m *RootRotationState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RootRotationState) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.NewCACert) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.NewCACert)))
		i += copy(dAtA[i:], m.NewCACert)
	}
	if len(m.NewCAKey) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.NewCAKey)))
		i += copy(dAtA[i:], m.NewCAKey)
	}
	if len(m.OldCACert) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.OldCACert)))
		i += copy(dAtA[i:], m.OldCACert)
	}
	if len(m.OldCAKey) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.OldCAKey)))
		i += copy(dAtA[i:], m.OldCAKey)
	}
	return i, nil
}
...
func (m *RootRotationState) Size() (n int) {
	var l int
	_ = l
	if m.State != 0 {
		n += 1 + sovTypes(uint64(m.State))
...
func (this *RootRotationState) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RootRotationState{`,
		`State:` + fmt.Sprintf("%v", this.State) + `,`,
		`NewCACert:` + fmt.Sprintf("%v", this.NewCACert) + `,`,
		`NewCAKey:` + fmt.Sprintf("%v", this.NewCAKey) + `,`,
		`OldCACert:` + fmt.Sprintf("%v", this.OldCACert) + `,`,
		`OldCAKey:` + fmt.Sprintf("%v", this.OldCAKey) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RootRotationState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RootRotationState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RootRotationState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= (RootRotationState_State(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewCACert", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NewCACert = append(m.NewCACert[:0], dAtA[iNdEx:postIndex]...)
			if m.NewCACert == nil {
				m.NewCACert = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewCAKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NewCAKey = append(m.NewCAKey[:0], dAtA[iNdEx:postIndex]...)
			if m.NewCAKey == nil {
				m.NewCAKey = []byte{}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OldCACert", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OldCACert = append(m.OldCACert[:0], dAtA[iNdEx:postIndex]...)
			if m.OldCACert == nil {
				m.OldCACert = []byte{}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OldCAKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OldCAKey = append(m.OldCAKey[:0], dAtA[iNdEx:postIndex]...)
			if m.OldCAKey == nil {
				m.OldCAKey = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorTypes = []byte{
	// 4249 bytes of a gzipped FileDescriptorProto
	,
}
