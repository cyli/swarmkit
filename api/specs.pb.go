...
type SecretSpec struct {
	...
	// Secret payload.
	Data []*SecretData `protobuf:"bytes,4,rep,name=data" json:"data,omitempty"`
}
...
func (m *SecretSpec) Copy() *SecretSpec {
	...
	if m.Data != nil {
		o.Data = make([]*SecretData, 0, len(m.Data))
		for _, v := range m.Data {
			o.Data = append(o.Data, v.Copy())
		}
	}
...
func (this *SecretSpec) String() string {
	...
	s := strings.Join([]string{`&SecretSpec{`,
		...
		`Data:` + strings.Replace(fmt.Sprintf("%v", this.Data), "SecretData", "SecretData", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SecretSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Data = append(m.Data, &SecretData{})
...
var fileDescriptorSpecs = []byte{
	...
	,
}
