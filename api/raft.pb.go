...
type JoinRequest struct {
	// Addr specifies the address of the member, including a port. A
	// wildcard address means the receiving side should resolve the peer's
	// address.
...
type ProcessRaftMessageResponse struct {
	// AddrMismatch tells the sending peer that its observed address does
	// not match the address stored in Raft. Based on this, the peer may
	// decide to call Join again to update its address.
	AddrMismatch bool `protobuf:"varint,1,opt,name=addr_mismatch,json=addrMismatch,proto3" json:"addr_mismatch,omitempty"`
}
...
type ResolveAddressResponse struct {
	// Addr specifies the address of the member, including a port.
	Addr string `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`
}
...
func (m *ProcessRaftMessageResponse) CopyFrom(src interface{}) {
	...
	o := src.(*ProcessRaftMessageResponse)
	*m = *o
}
...
func (this *ProcessRaftMessageResponse) String() string {
	...
	s := strings.Join([]string{`&ProcessRaftMessageResponse{`,
		`AddrMismatch:` + fmt.Sprintf("%v", this.AddrMismatch) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ProcessRaftMessageResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddrMismatch", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorRaft = []byte{
	...
	,
}
